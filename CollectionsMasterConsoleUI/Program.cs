...
namespace CollectionsMasterConsoleUI
{
    class Program
    {
        ...
        private static void NumberChecker(List<int> numList, int searchNumber)
        {
            ...
            {
                Console.WriteLine($"Yes we have that number in our list.");
            }
            else
            {
                Console.WriteLine($"No we do not have that number in our list.");
                Console.WriteLine($"That is not a number we are looking for.");
            }
